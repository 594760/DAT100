...
public class OppgaveG1 {
	...
	public static void skrivUt(double[][] tabell) {
		...
		public static void oppgaveBogC(double[][] obs) {
			System.out.println(obs.length);
			System.out.println(
					"Den skriver ut 3 fordi men obs.length sjekker han hvor mange tabeller det er i flerdimesjonaletabellen.");
			System.out.println();

			System.out.println(obs[0].length);
			System.out.println(
					"Den skriver ut 4 fordi men obs[0].length sjekker han hvor mange elementer det er i den første tabellen i flerdimesjonaletabellen.");
			System.out.println();

			System.out.println(obs[1].length);
			System.out.println(
					"Den skriver ut 5 fordi men obs[1].length sjekker han hvor mange elementer det er i den andre tabellen i  flerdimesjonaletabellen.");
			System.out.println();

			System.out.println(obs[2].length);
			System.out.println(
					"Den skriver ut 3 fordi men obs[2].length sjekker han hvor mange elementer det er i den tredje tabellen i flerdimesjonaletabellen.");
			System.out.println();
		}
